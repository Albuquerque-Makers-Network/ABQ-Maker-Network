      ...
      <Container className="p-5 ps-lg-0 mt-5 mx-auto rounded-4" id="background-about-me">
        <Row>
          ...
          <Col lg={6} className="order-3 order-sm-2 text-light">
            <h1 className="text-center text-md-start">profileFullName</h1>
            <p className="mt-3">profileAboutMe: As High as Honor. The winds of Winter. Never Resting. Can a
          ...
          <Col className="order-2 order-sm-3 my-3 mt-lg-0 d-block d-lg-inline">
            <h2 className="text-center text-lg-start text-light">Skills:</h2>
            <Skill/>
          </Col>
